...
| address_line_1           | VARCHAR |    |!...........m| customer_id       | VARCHAR | FK("customers") |!....................m| order_id       | VARCHAR | FK("orders") |    
...
| product_id          | VARCHAR | PK                |   | product_id        | VARCHAR | FK("products") |                                                 
| product_type_id     | VARCHAR | FK("order_items") |!.m| product_quantity  | VARCHAR |                |                                                 
...
| parent_type_id           | VARCHAR? | FK("product_types") |
