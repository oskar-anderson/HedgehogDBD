...
export const AttributeModal  : React.FC<EditAttributeModelProps> = ({   handleSaveAttribute  , setRows , table ,     handleRankUp , handleSave ,  handleDeleteAttribute , hanldeRankDown ,setModalInfo , modalInfo  })=>{
