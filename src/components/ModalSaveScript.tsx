    ...
    return (
        <div className="modal-content">
            <div className="modal-header">
                ...
                <button type="button" className="btn-close" onClick={() => setModalSaveScriptState(false)} data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div className="modal-footer">
                <button type="button" className="btn btn-secondary" onClick={() => setModalSaveScriptState(false)} data-bs-dismiss="modal">Cancel</button>
