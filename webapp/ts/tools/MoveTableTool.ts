...
// Todo Rename this file to match class name 
export class SelectTableTool implements ITool {
    ...
    exit() {
        console.log("MoveTableTool exit");
    ...
    mouseDown = () => {
        console.log("MoveTableTool mouseDown")
        this.isDirty = false;
        let mouseCharGrid = this.draw.getMouseCharGridPosition();
    ...
    updateHoverTablePosition(mouseCharGridX: number, mouseCharGridY: number) {
        console.log("MoveTableTool updateHoverTablePosition")
    ...
    mouseEventUp(mouseCharGridX: number, mouseCharGridY: number) {
        console.log("MoveTableTool mouseEventUp");
